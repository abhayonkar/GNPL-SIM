...
import PipelineV2     from "../pipeline_architecture_v2.jsx";
import PipelineV3     from "../pipeline_architecture_v3.jsx";
import SaveToStorage  from "../save_to_storage.jsx";

const TABS = [
  { key: "arch",     label: "System Architecture",       Component: ArchDiagram   },
  { key: "pipeline", label: "v1 · Simulated (20-node)",  Component: PipelineArch  },
  { key: "v2",       label: "v2 · Gandhinagar SGL",      Component: PipelineV2    },
  { key: "v3",       label: "v3 · IGL Delhi SW",         Component: PipelineV3    },
